...
class ProjectTaskType(models.Model):
    ...
    user_id = fields.Many2one('hr.employee', 'Stage Owner', index=True)
...
class Project(models.Model):
    ...
    favorite_user_ids = fields.Many2many(
        'hr.employee', 'project_favorite_user_rel', 'project_id', 'user_id',
    ...
    user_id = fields.Many2one('hr.employee', string='Project Manager', default=lambda self: self.env.user, tracking=True)
...
class Task(models.Model):
    ...
    manager_id = fields.Many2one('hr.employee', string='Project Manager', related='project_id.user_id', readonly=True)
    ...
    def _message_auto_subscribe_followers(self, updated_values, default_subtype_ids):
        ...
        users = self.env['hr.employee'].browse(value)
        for user in users:
            try:
                if user.partner_id:
